...
export const ChartsSection: React.FC<ChartsSectionProps> = ({
  ...
  // Create meaningful expense breakdown data
  const expenseChartData = [
    {
      label: "Groceries",
      value: Math.round(currentMonthRevenue.expenses * 0.6),
      forecast: Math.round(currentMonthRevenue.expenses * 0.6 * 1.02),
    ...
    {
      label: "Utilities",
      value: Math.round(currentMonthRevenue.expenses * 0.25),
      forecast: Math.round(currentMonthRevenue.expenses * 0.25 * 1.01),
      color: "#6366f1",
    ...
    {
      label: "Maintenance",
      value: Math.round(currentMonthRevenue.expenses * 0.15),
      forecast: Math.round(currentMonthRevenue.expenses * 0.15 * 1.03),
      color: "#f59e0b",
